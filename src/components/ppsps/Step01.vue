  ...
  <div class="col-md-12">
    <div class="row">
      <div class="form-group col-md-6 w-50">
        ...
        <input
          type="text"
          class="form-control"
          :class="{ 'is-error': $store.getters.errors.includes('last_name') }"
      ...
      <div class="form-group col-md-6 w-50">
        ...
        <input
          type="text"
          class="form-control"
          :class="{ 'is-error': $store.getters.errors.includes('first_name') }"
    ...
    <div class="form-group">
      ...
      <input
        type="text"
        class="form-control"
        :class="{ 'is-error': $store.getters.errors.includes('chantier_name') }"
...
export default {
  methods: {
    // upload the logo of the PPSPS
    uploadLogo(event) {
      this.$store.state.pps_ps.logo_path = event.target.files[0];
    },
  },
};
</script>
