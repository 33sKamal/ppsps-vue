<template>    
    <div class="block-content">
        <div class="row py-sm-3">
                    ...
                    <div class="col-md-6 mb-5 pb-5 border border-light" 
                    v-for="soutrait in pps_ps.soutraits" 
                    :key="soutrait.id">
                        
                        <div class="block-header">
                            <h3 class="block-title">Entreprise N: <small>{{soutrait.id}}</small></h3>
                        </div>
                        <div class="block-content">
                            ...
                            <div class="form-inline justify-content-between mb-3">
                                ...
                                :class="{'is-error':[].includes('name'+soutrait.id)}"                             
                                 :id="'name'+soutrait.id"
                            ...
                            <div class="form-inline justify-content-between mb-3">
                               ...
                               <input 
                                ...
                                class="form-control form-control-alt input-validate "
                                 kamal-v-validate="'required'"
                                :class="{'is-error':[].includes('address'+soutrait.id)}"                             
                            ...
                            <div class="form-group">
                                <label for="soutrait.nature">Nature des travaux sous-traités  :</label>
                                <textarea
                                class="form-control form-control-alt input-validate "
                                 kamal-v-validate="'required'"
                                :class="{'is-error':[].includes('nature'+soutrait.id)}"                             
                            ...
                            <div class="custom-control custom-switch custom-control-success">
                                <input 
                                type="checkbox" 
                            :class="{'is-error':[].includes('diff_ppsps'+soutrait.id)}"                            
...
export default {
    ...
    methods:{
        validateForm(){
            let elements  = document.querySelectorAll('.input-validate ')
            let ids=[]
